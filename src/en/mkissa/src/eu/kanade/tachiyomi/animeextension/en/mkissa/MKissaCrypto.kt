...
object MKissaCrypto {
    ...
    private const val SALT_MUL = 180
    private const val SALT_ADD = 34
    private const val FRAG_MUL = 228
    private const val FRAG_ADD = 118
    private const val BOOT_PREFIX = "nQoBmFr:"
